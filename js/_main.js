...
( function( $ ) {
	...
	$body.imagesLoaded( function() {
		setTimeout(function() {
		      ...
		      // Init navigation no longer used
		      //initHomepageNav();
	...
	function adjustWindow(){
	    ...
	    // Resize our slides
	    $slide.height(winH+75);
			$slide3.height(winH+270);
			$lastSlide.height(winH+500);

			$firstSeparator.height(400);
	    $slideTall.height(winH*2);
	    $slideTall2.height(winH*3);

//floatimage
/*
var firstImage = document.getElementById("floatimage1");
console.log(firstImage.innerHTMLf);
firstImage.style.margin-top(winH);
